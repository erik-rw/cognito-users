...
const configSchema = z.object({
    AWS_ACCESS_KEY_ID: z.string({
        required_error: 'AWS_ACCESS_KEY_ID is required. Export the AWS_ACCESS_KEY_ID environment variable.',
    }),
    AWS_SECRET_ACCESS_KEY: z.string({
        required_error: 'AWS_SECRET_ACCESS_KEY is required. Export the AWS_SECRET_ACCESS_KEY environment variable.',
    }),
    AWS_REGION: z.string({
        required_error: 'AWS_REGION is required. Export the AWS_REGION environment variable.',
    }),
    COGNITO_USER_POOL_ID: z.string({
        required_error: 'UserPoolId is required. Export the COGNITO_USER_POOL_ID environment variable.',
    }),
});
